...
window.addEventListener("DOMContentLoaded",
    ...
    const omikujiText = document.getElementsById("omikujiText");
    ...
    function() {
      ...
      let resultColor = ["#ff0000","#ffff00","#0000ff","#008000","#ff8c00","#2f4f4f"];
      ...
      let  = Math.floor(Math.random() * resultText.legth);
      omikujiText.textCotet = resultText[n];
      omikujiText.style.color = resultColor[n];
      omikujiText.style.fontSize = resultFontSize[n];

      w_sound = resultSound[n];
      soundContol("start", w_sound);
      soundEndflag = "1";  
